...
Caroline.John.Composer.SetSound("a-", { duration = 0.032, file = "caroline/john/rjigir0e3-3jgifi3.wav" })

Caroline.John.Model <- Caroline.Model(Caroline.John.Parser, Caroline.John.Composer)
